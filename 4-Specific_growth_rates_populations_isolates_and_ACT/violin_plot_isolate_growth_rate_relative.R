...
# Read Excel data
df <- read_excel("Growth_rates_isolates_relative.xlsx")
...
ggsave("Isolates_relative_growth_rate.png", plot = p_violin, width = 10, height = 7, dpi = 300, bg = "white")