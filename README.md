...
This includes the colony morphology plate images used in counts, the diversity index raw data, compiled set for input into the R script, the script itself and the subset of figure 1 (1d).

3_Aggregate_morphology:

This includes the images including marked area of measurement (Flatten_area_scale_bar), area measurements (Area measurements.xlsx), R scripts, data input (data_long_mm-edit.csv) and output (.png).
